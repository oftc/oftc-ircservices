...
int nickname_ajoin_delete(int, int);
...
/* Nickname setters */
int nickname_set_id(Nickname *, unsigned int);
int nickname_set_nickid(Nickname *, unsigned int);
int nickname_set_pri_nickid(Nickname *, unsigned int);
int nickname_set_nick(Nickname *, const char *);
int nickname_set_pass(Nickname *, const char *);
int nickname_set_salt(Nickname *, const char *);
int nickname_set_cloak(Nickname *, const char *);
int nickname_set_email(Nickname *, const char *);
int nickname_set_url(Nickname *, const char *);
int nickname_set_last_realname(Nickname *, const char *);
int nickname_set_last_host(Nickname *, const char *);
int nickname_set_last_quit(Nickname *, const char *);
int nickname_set_status(Nickname *, unsigned int);
int nickname_set_language(Nickname *, unsigned int);
int nickname_set_enforce(Nickname *, unsigned char);
int nickname_set_secure(Nickname *, unsigned char);
int nickname_set_verified(Nickname *, unsigned char);
int nickname_set_cloak_on(Nickname *, unsigned char);
int nickname_set_admin(Nickname *, unsigned char);
int nickname_set_email_verified(Nickname *, unsigned char);
int nickname_set_priv(Nickname *, unsigned char);
int nickname_set_reg_time(Nickname *, time_t);
int nickname_set_last_seen(Nickname *, time_t);
int nickname_set_last_quit_time(Nickname *, time_t);
#endif
