 ...
 *  USA
 *
 *  $Id: modules.c 606 2006-06-08 22:35:55Z stu $
 */
...
#if 0
static void mo_modload(client_t *, client_t *, int, char *[]);
static void mo_modlist(client_t *, client_t *, int, char *[]);
static void mo_modreload(client_t *, client_t *, int, char *[]);
static void mo_modunload(client_t *, client_t *, int, char *[]);
static void mo_modrestart(client_t *, client_t *, int, char *[]);

message_t modload_msgtab = {
 "MODLOAD", 0, 0, 2, 0, MFLG_SLOW, 0,
  {m_ignore, m_ignore, mo_modload, m_ignore}
};

message_t modunload_msgtab = {
 "MODUNLOAD", 0, 0, 2, 0, MFLG_SLOW, 0,
  {m_ignore, m_ignore, mo_modunload, m_ignore}
};

message_t modreload_msgtab = {
  "MODRELOAD", 0, 0, 2, 0, MFLG_SLOW, 0,
  {m_ignore, m_ignore, mo_modreload, m_ignore}
};

message_t modlist_msgtab = {
 "MODLIST", 0, 0, 0, 0, MFLG_SLOW, 0,
  {m_ignore, m_ignore, mo_modlist, m_ignore}
};

message_t modrestart_msgtab = {
 "MODRESTART", 0, 0, 0, 0, MFLG_SLOW, 0,
 {m_ignore, m_ignore, mo_modrestart, m_ignore}
};
#endif
...
/* load a module .. */
static void
mo_modload(client_t *client_p, client_t *source_p,
           int parc, char *parv[])
{
  char *m_bn;
...
/* unload a module .. */
static void
mo_modunload(client_t *client_p, client_t *source_p,
             int parc, char *parv[])
{
  char *m_bn;
  dlink_node *ptr;
...
static void
mo_modreload(client_t *client_p, client_t *source_p,
             int parc, char *parv[])
{
  char *m_bn;
  dlink_node *ptr;
...
/* list modules .. */
static void
mo_modlist(client_t *client_p, client_t *source_p,
	   int parc, char *parv[])
{
  dlink_node *ptr;
  struct module *modp;
...
static void
mo_modrestart(client_t *client_p, client_t *source_p,
              int parc, char *parv[])
{
