...
static struct ServiceMessage register_msgtab = {
  NULL, "REGISTER", 0, 2, SFLG_UNREGOK, CHIDENTIFIED_FLAG, CS_HELP_REG_SHORT, 
  CS_HELP_REG_LONG, m_register
};

static struct ServiceMessage help_msgtab = {
  NULL, "HELP", 0, 0, SFLG_UNREGOK, CHUSER_FLAG, CS_HELP_SHORT, 
  CS_HELP_LONG, m_help
};

static struct ServiceMessage set_sub[] = {
  { NULL, "DESC", 0, 1, 0, MASTER_FLAG, CS_HELP_SET_DESC_SHORT, 
    CS_HELP_SET_DESC_LONG, m_set_desc },
  { NULL, "URL", 0, 1, 0, MASTER_FLAG, CS_HELP_SET_URL_SHORT, 
    CS_HELP_SET_URL_LONG, m_set_url },
  { NULL, "EMAIL", 0, 1, 0, MASTER_FLAG, CS_HELP_SET_EMAIL_SHORT, 
    CS_HELP_SET_EMAIL_LONG, m_set_email },
  { NULL, "ENTRYMSG", 0, 1, 0, CHANOP_FLAG, CS_HELP_SET_ENTRYMSG_SHORT, 
    CS_HELP_SET_ENTRYMSG_LONG, m_set_entrymsg },
  { NULL, "TOPIC", 0, 1, 0, CHANOP_FLAG, CS_HELP_SET_TOPIC_SHORT, 
    CS_HELP_SET_TOPIC_LONG, m_set_topic },
  { NULL, "TOPICLOCK", 0, 1, 0, MASTER_FLAG, CS_HELP_SET_TOPICLOCK_SHORT, 
    CS_HELP_SET_TOPICLOCK_LONG, m_set_topiclock },
  { NULL, "MLOCK", 0, 1, 0, MASTER_FLAG, CS_HELP_SET_MLOCK_SHORT, 
    CS_HELP_SET_MLOCK_LONG, m_not_avail }, 
  { NULL, "PRIVATE", 0, 1, 0, MASTER_FLAG, CS_HELP_SET_PRIVATE_SHORT, 
    CS_HELP_SET_PRIVATE_LONG, m_set_private },
  { NULL, "RESTRICTED", 0, 1, 0, MASTER_FLAG, CS_HELP_SET_RESTRICTED_SHORT, 
    CS_HELP_SET_RESTRICTED_LONG, m_set_restricted },
  { NULL, "VERBOSE", 0, 1, 0, MASTER_FLAG, CS_HELP_SET_VERBOSE_SHORT, 
    CS_HELP_SET_VERBOSE_LONG, m_set_verbose },
  { NULL, "AUTOLIMIT", 0, 1, 0, MASTER_FLAG, CS_HELP_SET_AUTOLIMIT_SHORT, 
    CS_HELP_SET_AUTOLIMIT_LONG, m_not_avail },
  { NULL, "EXPIREBANS", 0, 1, 0, MASTER_FLAG, CS_HELP_SET_EXPIREBANS_SHORT, 
...
static struct ServiceMessage access_sub[6] = {
  { NULL, "ADD", 0, 4, 0, MASTER_FLAG, CS_HELP_ACCESS_ADD_SHORT, 
    CS_HELP_ACCESS_ADD_LONG, m_access_add },
  { NULL, "DEL", 0, 2, 0, MASTER_FLAG, CS_HELP_ACCESS_DEL_SHORT, 
    CS_HELP_ACCESS_DEL_LONG, m_access_del },
  { NULL, "LIST", 0, 2, 0, CHUSER_FLAG, CS_HELP_ACCESS_LIST_SHORT, 
...
static struct ServiceMessage akick_sub[] = {
  { NULL, "ADD", 0, 3, 0, CHANOP_FLAG, CS_HELP_AKICK_ADD_SHORT, 
    CS_HELP_AKICK_ADD_LONG, m_akick_add }, 
  { NULL, "DEL", 0, 1, 0, CHANOP_FLAG, CS_HELP_AKICK_DEL_SHORT, 
    CS_HELP_AKICK_DEL_LONG, m_akick_del },
  { NULL, "LIST", 0, 1, 0, MEMBER_FLAG, CS_HELP_AKICK_LIST_SHORT, 
    CS_HELP_AKICK_LIST_LONG, m_akick_list },
  { NULL, "ENFORCE", 0, 0, 0, MEMBER_FLAG, CS_HELP_AKICK_ENFORCE_SHORT, 
...
static struct ServiceMessage drop_msgtab = {
  NULL, "DROP", 0, 1, 0, MASTER_FLAG, CS_HELP_DROP_SHORT, 
  CS_HELP_DROP_LONG, m_drop
};

static struct ServiceMessage info_msgtab = {
  NULL, "INFO", 0, 1, 0, CHUSER_FLAG, CS_HELP_INFO_SHORT, 
  CS_HELP_INFO_LONG, m_info
};

static struct ServiceMessage op_msgtab = {
  NULL, "OP", 0, 1, 0, CHANOP_FLAG, CS_HELP_OP_SHORT, CS_HELP_OP_LONG, m_op
};

static struct ServiceMessage deop_msgtab = {
  NULL, "DEOP", 0, 1, 0, CHANOP_FLAG, CS_HELP_DEOP_SHORT, 
  CS_HELP_DEOP_LONG, m_deop
};

static struct ServiceMessage unban_msgtab = {
  NULL, "UNBAN", 0, 1, 0, MEMBER_FLAG, CS_HELP_UNBAN_SHORT, 
  CS_HELP_UNBAN_LONG, m_unban
};

static struct ServiceMessage invite_msgtab = {
  NULL, "INVITE", 0, 1, 0, MEMBER_FLAG, CS_HELP_INVITE_SHORT, 
  CS_HELP_INVITE_LONG, m_invite
};

static struct ServiceMessage clear_sub[] = {
  { NULL, "BANS", 0, 1, 0, CHANOP_FLAG, CS_HELP_CLEAR_BANS_SHORT, 
    CS_HELP_CLEAR_BANS_LONG, m_clear_bans },
  { NULL, "OPS", 0, 1, 0, CHANOP_FLAG, CS_HELP_CLEAR_OPS_SHORT, 
    CS_HELP_CLEAR_OPS_LONG, m_clear_ops },
  { NULL, "VOICES", 0, 0, 0, CHANOP_FLAG, CS_HELP_CLEAR_VOICES_SHORT, 
    CS_HELP_CLEAR_VOICES_LONG, m_clear_voices },
  { NULL, "USERS", 0, 0, 0, MASTER_FLAG, CS_HELP_CLEAR_USERS_SHORT, 
